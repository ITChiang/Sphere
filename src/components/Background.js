...
var cameraControl;
var id; // tracking animate frame id
...
var init = () => {
    ...
    //camera.position.y = 1 * Math.cos(10);
...
var removeScene = () => {
    ...
    var _btn = document.getElementsByClassName('intro_enterBtn')[0]; // tirgger fadeout three .js
    var _bgcover = document.getElementsByClassName('bg_cover')[0]; // tirgger fadeout three .js
    var _bgfooter = document.getElementsByClassName('bg_footer')[0]; // tirgger fadeout three .js
    _btn.style = "display:none";
    _bgcover.style = "display:none";
...
class Background extends Component {
    ...
    removeHandler() {
        var _canvas = document.getElementsByTagName('canvas')[0]; // tirgger fadeout three .js
        var _btn = document.getElementsByClassName('intro_enterBtn')[0]; // tirgger fadeout three .js
        var _bgcover = document.getElementsByClassName('bg_cover')[0]; // tirgger fadeout three .js
        var _bgfooter = document.getElementsByClassName('bg_footer')[0]; // tirgger fadeout three .js
        _canvas.classList.add("canvas_active");
        _btn.classList.add("canvas_active");
        _bgcover.classList.add("canvas_active");
        _bgfooter.classList.add("canvas_active");
        setTimeout(()=>removeScene(),2000);
    }
    render() {
        return (
            <div className="App">
                <div className="bg_cover">I-Tung Chiang - 2021</div>
                <button className="intro_enterBtn" onClick={this.removeHandler}>Enter</button>
                <div className="bg_footer">Click blocks or Press C</div>
            </div>
        );
    }
}
